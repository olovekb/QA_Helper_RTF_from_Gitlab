...
- Scenario = одно пользовательское действие (НЕ техническое!). Текст начинается с глагола действия пользователя: "Нажать", "Ввести", "Выбрать". ❌ НЕ "Загрузить страницу", "Открыть приложение" - это технические действия! ❌ НЕ "Выполнить пользовательское действие" - это placeholder!
...
3. ✅ Объединяй связанные требования в одну Story, даже если они в разных разделах документа
