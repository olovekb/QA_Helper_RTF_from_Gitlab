...
# Скрипт для автоматической настройки базы данных PostgreSQL для проекта tia-mapping-service

# Проверка наличия утилиты psql
if ! command -v psql &> /dev/null; then
    echo "PostgreSQL не установлен или утилита psql не найдена в PATH. Установите PostgreSQL и добавьте psql в PATH."
    exit 1
fi
...
# Применение миграций через Knex для создания таблиц
